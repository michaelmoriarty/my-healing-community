---
description: >-
  DDW section landing page covering what it is, why it matters in oncology,
  protocol questions, evidence by cancer type, and where to jump next
---
...
* go next to [Evidence by Cancer Type](ddw-evidence-by-cancer-type/) for the cancer-specific map
* go to [DDW and Pancreatic Cancer](ddw-evidence-by-cancer-type/ddw-and-pancreatic-cancer.md) for the clearest tumour-specific human study
* go to [DDW Protocol Variation and Lower Limits](ddw-protocol-variation-and-lower-limits.md) for the lower-ppm debate
* go to [DDW Sourcing and Brand Options](ddw-sourcing-and-brand-options.md) for the buying and brand overview

### Start here if...

* **you are new to DDW:** stay on this page, then go to [Evidence by Cancer Type](ddw-evidence-by-cancer-type/)
* **you want the strongest human signal first:** go straight to [DDW and Pancreatic Cancer](ddw-evidence-by-cancer-type/ddw-and-pancreatic-cancer.md)
* **you are confused by different ppm advice:** go to [DDW Protocol Variation and Lower Limits](ddw-protocol-variation-and-lower-limits.md)
* **you want practical buying help:** go to [DDW Sourcing and Brand Options](ddw-sourcing-and-brand-options.md)
...
The next page in this section, [Evidence by Cancer Type](ddw-evidence-by-cancer-type/), gives a cancer-type view of the DDW literature. It currently covers pancreatic, colorectal, breast, lung, nasopharyngeal, prostate, and mixed-cancer human data.
...
For a fuller explanation of this debate, see [DDW Protocol Variation and Lower Limits](ddw-protocol-variation-and-lower-limits.md).
...
<summary>Expand to read the main animal radioprotection findings</summary>
...
<summary>Notes on dosing: mixing DDW and regular water</summary>
...
| Target ppm | 25 ppm DDW | 150 ppm regular water |
| ---------- | ---------- | --------------------- |
| 85         | 0.75 L     | 0.75 L                |
| 65         | 1.00 L     | 0.50 L                |
| 45         | 1.25 L     | 0.25 L                |
...
For a calculator-based approach, use the [deuterium dilution calculator](https://www.nourishmeorganics.com.au/pages/deuterium-dilution-calculator).

### Step 3: Prepare the mixture

1. Measure each volume with a clean jug.
2. Pour both waters into a clean container.
3. They usually mix together well as you pour.
4. Drink that mixture across the day.
5. Replace other drinking water including tea and coffee and soups with the same mixture during the protocol.
...
<summary>A holiday pause — or a gap while waiting for finances to improve or a shipment to arrive — is best framed as a passive re-challenge. Expand to read more...</summary>
...
[https://journals.sagepub.com/doi/10.1177/10732748211068963](https://journals.sagepub.com/doi/10.1177/10732748211068963)
...
[https://pmc.ncbi.nlm.nih.gov/articles/PMC12025113/](https://pmc.ncbi.nlm.nih.gov/articles/PMC12025113/)

Deuterium Depletion as a Novel Metabolic Approach in Oncology: Mechanistic Rationale and Clinical Relevance\
[https://pmc.ncbi.nlm.nih.gov/articles/PMC12673895/](https://pmc.ncbi.nlm.nih.gov/articles/PMC12673895/)
...
[https://pmc.ncbi.nlm.nih.gov/articles/PMC11085166/](https://pmc.ncbi.nlm.nih.gov/articles/PMC11085166/)
...
[https://www.spandidos-publications.com/10.3892/or.2025.8903](https://www.spandidos-publications.com/10.3892/or.2025.8903)

Research Concerning the Radioprotective and Immunostimulating Effects of Deuterium-Depleted Water\
[https://pubmed.ncbi.nlm.nih.gov/11797936/](https://pubmed.ncbi.nlm.nih.gov/11797936/)
